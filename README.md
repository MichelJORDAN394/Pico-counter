...
Le Raspberry Pico W assure l'alimentation 5V du capteur à effet Hall, le comptage des impulsions est la transmission des mesures via une page Web rafraîchie automatiquement tous les 20s.
