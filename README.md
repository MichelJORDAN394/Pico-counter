...
Un simple diviseur de tension ramène la tension de sortie à 3V, compatible avec les niveaux d'entrée du Pico.
...
Deux solutions sont possibles pour le comptage, soit compter les interruptions génèrees par un front descendant, soit utiliser les impulsions comme horloge d'un des PWM du Pico. La seconde solution est celle retenue dans la mesure où le temps de traitement des interruptions en MicroPython peut atteindre une durée critique. La bibliothèque utilisée est .
